		      					...
		      					<table class="table table-striped table-bordered">
		      						...
		      						foreach($result as $row)
		      						{
		      							...
		      							<tr>
		      								...
		      								<td>'.$row["doctor_expert_in"].'</br><img src="images/'.$row["doctor_expert_in"].'.jpeg" width="120 " height="100"/></td>
		      								...
		      								<td><button type="button" name="get_appointment" class="btn btn-primary btn-sm 
											get_appointment" data-id="'.$row["doctor_schedule_id"].'">Get Appointment</button></td>
		      							</tr>
		      							';
		      						}
		      						?>
