...
<div style="background-color:powderblue;" class="container-fluid">
	<?php
	include('navbar.php');
	?>
	<br />
	<div style="background-color:lightyellow;" class="card">
			...
			<div class="card-body">
				<div class="table-responsive">
		      		<table  class="table table-striped table-bordered" id="appointment_list_table">
		      			<thead >
			      			<tr >
			      				<th style="background-color:powderblue;">Doctor Name</th>
			      				<th style="background-color:powderblue;">Education</th>
			      				<th style="background-color:powderblue;">Speciality</th>
			      				<th style="background-color:powderblue;">Appointment Date</th>
			      				<th style="background-color:powderblue;">Appointment Day</th>
			      				<th style="background-color:powderblue;">Available Time</th>
